...
export const CIRCLES: { name: string; theme: string; address: string }[] = [
  ...
  {
    name: "Agent Treasury",
    theme: "A circle an AI assistant can save into for you",
    address: "0x2C6F01FcA31578b68fe01dfb299e34114fe6a626",
  },
  { name: "Quick Draw", theme: "Fast rounds, small amounts", address: "0x99A2c50A6Cc6484EA98e70873888d4AC913e6b65" },
  {
    name: "Demo Round",
    theme: "A finished round — a winner has been drawn",
    address: "0x708c5db121098974CBe0Eac770FCC15C182217D1",
  },
];
...
export const PROOFS: { step: string; txHash: string }[] = [
  ...
  {
    step: "Added coins to the pool — privately",
    txHash: "0xefcd6431460e548bc68f969339af1ab305c41976dce8202a6876c220c6869d5c",
  },
  {
    step: "Added prize money (from yield)",
    txHash: "0xe269f4dd9d945035c0633eb0c42e3f2279bcdae68200e07efb9cf9117c8604ec",
  },
  {
    step: "Locked in a secret for the draw",
    txHash: "0x9ced5f58028be9e7383e6c56031a829da9057669cd3d509ea3c58bac601886b1",
  },
  {
    step: "Revealed the secret — public randomness",
    txHash: "0xb852e6d4ed39a46c2ac66073ef27ed6bd8facdc9f087a75443e795d279ade31d",
  },
  {
    step: "Worked out everyone’s odds — fairly",
    txHash: "0x2e8d566129e317ebd61e7bd8ef3a205cd671b6ae9b831c68380a085e3e2fe20c",
  },
  {
    step: "Picked one winner — over hidden balances",
    txHash: "0xd4d7ea604878136301228ad6a25299d6e4dc28dfd4565bcb205bfd18b19adf40",
  },
  ...
  {
    step: "Took money out — savings + winnings",
    txHash: "0x6b5240775f662818df35a188479b7aa69eb619298223f949f024bce55f11092a",
  },
  {
    step: "🛡️ An AI assistant saved into the pool",
    txHash: "0xa8482b7c458b276645dfd5fded8be505970ce1cc957bb1d5f63490f0434738bc",
  },
];
